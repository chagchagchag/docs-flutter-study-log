Dart 를 사용해서 앱 개발을 하면 IOS, AOS 로 통일된 디자인으로 배포를 할 수 있다는 장점이 있습니다. 그런데 배포시 심사로 인해 시간이 오래걸린다는 문제가 있습니다. 그런데!!! [Shorebird 서비스](https://shorebird.dev/)에서 제공하는 코드 푸시기능을 이용하면 심사 없이 바로 배포가 가능하다고 합니다.<br/>
